...
export default function SignUp() {
	...
	const handleSubmit = onetime(async (e: FormEvent<HTMLFormElement> | any) => {
		...
		if (username && email) {
			const authMsg = `Welcome to EcoFundMe!
      \nClick to sign in and accept the EcoFundMe Terms of Service.
			...
			try {
				...
				dispatch({
					...
					payload: {
						...
						message: `Welcome to EcoFundMe ${username}`,
					},
				})
	...
	return (
		<>
			<Head>
				<title>{"EcoFundMe | Sign Up"}</title>
				<meta
					name="description"
					content="EcoFundMe - Climate financing on the blockchain"
				/>
