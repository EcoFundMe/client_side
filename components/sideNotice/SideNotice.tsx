  ...
  return (
    <div className="sn-container fl-tl fl-c">
      <div className="sn-info">
        ...
        <p>{"Your pledge will support an ambitious creative project that has yet to be developed. There’s a risk that, despite a creator’s best efforts, your reward will not be fulfilled, and we urge you to consider this risk prior to pledging. EcoFundMe is not responsible for project claims or reward fulfillment."}</p>
      </div>
